...
class PlacesController extends Controller
{
    ...
    public function show($plc)
    {
        ...
        list($prevPage,$nextPage) = nextBook('App\Place','plid',$place->plid,'plid');
        
        return view('Place.show', compact(['place','article']))->with('prevPage', $prevPage)->with('nextPage', $nextPage);
    }
